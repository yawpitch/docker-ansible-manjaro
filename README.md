# Manjaro Rolling (latest) Ansible Test Image

[![Travis Automated build](https://travis-ci.org/yawpitch/docker-ansible-manjaro.svg?branch=rolling)](https://travis-ci.org/yawpitch/docker-ansible-manjaro/branches)
[![Docker Automated build](https://img.shields.io/docker/automated/yawpitch/docker-ansible-manjaro-rolling.svg?maxAge=2592000)](https://hub.docker.com/r/yawpitch/docker-ansible-manjaro-rolling/)

Dockerized Manjaro Rolling (latest) for Ansible playbook and role tests.
...
```sh
sudo docker pull yawpitch/docker-ansible-manjaro-rolling:latest
```
...
```sh
sudo docker build -t docker-ansible-manjaro-rolling .
```
